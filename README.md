...
| :--- | :--- | :--- |
| **Intel Core** | Core I5 14400 | Cerveau (Ultra-rapide) |
| **AMD Ryzen** | Ryzen 5 5500u (AVX-512) / ROCm | Oreille (Faster-Whisper) |
| **Rockchip (OPi 6+)** | CIX CD8180/CD8160 SoC | Bouche TTS / Audio -Transfert UDP |
